    ...
    public function run(): void
    {
        ...
        DB::table('sliders')->insert([
            ...
            [
                ...
                'image_path' => 'images/5276117098801340197.png',
                'sort_order' => 4,
                'is_active' => true,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'description_ua' => 'Сучасна матеріально-технічна база для проведення інноваційних досліджень та створення стартапів.',
                'description_en' => 'Modern material and technical infrastructure for conducting innovative research and launching startups.',
                'image_path' => 'images/5276117098801340186.png',
                'sort_order' => 6,
                'is_active' => true,
                'created_at' => $now,
                'updated_at' => $now,
