<!DOCTYPE html>
<html lang="<?php echo e($currentLocale ?? 'uk'); ?>">
<head>
    <meta charset="UTF-8">
...
<body>
    <header>
        <div class="container header-inner">
            <a href="<?php echo e(route('home')); ?>" class="logo-wrap" aria-label="Науковий парк Поліський університет">
                <img src="<?php echo e(asset('images/logo-science-park.png')); ?>" alt="Науковий парк Поліський університет" class="logo-img">
            </a>

            <input type="checkbox" id="nav-toggle">
            <label for="nav-toggle" class="burger">☰</label>
            <nav>
                <a href="<?php echo e(route('news.index')); ?>"><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'News' : 'Новини'); ?></a>
                <a href="<?php echo e(route('home')); ?>#about"><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'About Us' : 'Про нас'); ?></a>
                <div class="nav-item has-dropdown">
                    <a href="<?php echo e(route('activities.index')); ?>"><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Areas of Activity' : 'Напрями діяльності'); ?> <span class="chev"><?php echo $__env->make('partials.icons.chev', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></span></a>
                    <div class="dropdown">
                        <?php if(isset($menuActivities)): ?>
                            <?php $__currentLoopData = $menuActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('activities.index')); ?>#activity-<?php echo e($item->id); ?>"><?php echo e(($currentLocale ?? 'uk') === 'en' ? $item->title_en : $item->title_ua); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </div>
                </div>
                <a href="<?php echo e(route('opportunities.index')); ?>"><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Our Opportunities' : 'Наші можливості'); ?></a>
                <a href="<?php echo e(route('home')); ?>#contacts"><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Contacts' : 'Наші контакти'); ?></a>

                <div id="headerSearch"
                     class="header-search"
                     data-suggestions-url="<?php echo e(route('news.suggestions')); ?>"
                     data-empty-text="<?php echo e(($currentLocale ?? 'uk') === 'en' ? 'No suggestions found' : 'Підказок не знайдено'); ?>">
                    <button id="searchToggle"
                            class="search-icon"
                            type="button"
                            aria-controls="headerSearchPopover"
                            aria-expanded="false"
                            aria-label="<?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Search' : 'Пошук'); ?>"
                            title="<?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Search' : 'Пошук'); ?>">
                        ...
                        <form id="headerSearchForm"
                            ...
                            <div class="header-search-row">
                                <input id="headerSearchInput"
                                       ...
                                       type="search"
                                       name="q"
                                       value="<?php echo e(is_string(request('q')) ? request('q') : ''); ?>"
                                       placeholder="<?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Search news...' : 'Пошук новин...'); ?>"
                                       autocomplete="off">

                                <button class="header-search-submit" type="submit">
                                    <?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Search' : 'Знайти'); ?>
                ...
                <div class="locale-switch">
                    <?php if(($currentLocale ?? 'uk') === 'en'): ?>
                        <a href="<?php echo e(route('locale.switch', 'uk')); ?>" title="Українська">UA</a>
                        <span style="opacity:.6;margin:0 6px">|</span>
                        <span class="active">EN</span>
                    <?php else: ?>
                        <span class="active">UA</span>
                        <span style="opacity:.6;margin:0 6px">|</span>
                        <a href="<?php echo e(route('locale.switch', 'en')); ?>" title="English">EN</a>
                    <?php endif; ?>
                </div>
            </nav>
        </div>
        ...
        <div class="container">
            <div class="footer-card">
                <div class="footer-left">
                    <img src="<?php echo e(asset('images/icons/image-Photoroom (8).png')); ?>"
                         alt=""
                         class="footer-leaf-img"
                         aria-hidden="true">

                    <div class="footer-text">
                        <h4><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Building the Future Together' : 'Будуємо майбутнє разом'); ?></h4>
                        <p><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'Join a community of innovators, researchers, entrepreneurs and everyone striving to create positive change.' : 'Долучайтеся до спільноти інноваторів, дослідників, підприємців та всіх, хто прагне змін на краще!'); ?></p>
                    </div>
                </div>
                ...
                <div class="footer-center">
                    ...
                    <div class="footer-contact-line">
                        ...
                        <span><?php echo e(($currentLocale ?? 'uk') === 'en' ? '7 Staryi Boulevard, Zhytomyr, Zhytomyr Region, 10008, Ukraine' : '10008, Україна, Житомирська обл., м. Житомир, Старий бульвар, 7'); ?></span>
                    </div>
                ...
                <div class="footer-qr">
                    <img src="<?php echo e(asset('images/qr-code.png')); ?>" alt="QR-код">
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="<?php echo e(asset('js/hero-slider.js')); ?>" defer></script>
</body>
</html>
<?php /**PATH C:\laragon\www\polissia-science-park\resources\views/layouts/app.blade.php ENDPATH**/ ?>