<?php $__env->startSection('title', ($currentLocale ?? 'uk') === 'en' ? 'Home — Science Park Polissia University' : 'Головна — Поліський науковий парк'); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="sp-hero">
        ...
        <div class="sp-hero-collage">
            <div class="sp-photo sp-photo-top-left">
                <img src="<?php echo e(asset('images/5276117098801340184.png')); ?>" alt="Лабораторія з комп’ютерами">
            </div>

            <div class="sp-photo sp-photo-top-wide">
                <img src="<?php echo e(asset('images/5276117098801340186.png')); ?>" alt="Високотехнологічна техніка">
            </div>

            <div class="sp-photo sp-photo-bottom-left">
                <img src="<?php echo e(asset('images/5276117098801340195.png')); ?>" alt="Робототехніка">
            </div>

            <div class="sp-photo sp-photo-bottom-middle">
                <img src="<?php echo e(asset('images/5276117098801340197.png')); ?>" alt="Цифрове обладнання">
            </div>

            <div class="sp-photo sp-photo-bottom-right">
                <img src="<?php echo e(asset('images/5276117098801340193.png')); ?>" alt="Екологічні технології">
            </div>
    ...
    <section class="activities-bleed" style="background:var(--bg);width:100%;">
        <div class="container">
            <section id="activities">
                <h3 class="section-title" style="text-transform:uppercase"><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'AREAS OF ACTIVITY' : 'НАПРЯМИ ДІЯЛЬНОСТІ'); ?></h3>
                <?php echo $__env->make('partials.activities-grid', ['activities' => $activities], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </section>
        </div>
    </section>
    ...
    <div class="container home-bottom-container">
        <section id="opportunities" class="opportunities-section">
            <h3 class="section-title" style="text-transform:uppercase"><?php echo e(($currentLocale ?? 'uk') === 'en' ? 'OUR OPPORTUNITIES' : 'НАШІ МОЖЛИВОСТІ'); ?></h3>
            <?php echo $__env->make('partials.opportunities-grid', ['opportunities' => $opportunities], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </section>

        <?php echo $__env->make('partials.home-news', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->startSection('head'); ?>
    <style>
        ...
        .hero-bg-image {
            ...
            background:
                ...
                url("<?php echo e(asset('images/Gemini_Generated_Image_o9b7mfo9b7mfo9b7.png')); ?>");
    ...
    <style>
        ...
        @media (min-width: 901px) {
            /* Duplicate header rules removed - header styles live in layouts/app.blade.php */
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\polissia-science-park\resources\views/home.blade.php ENDPATH**/ ?>