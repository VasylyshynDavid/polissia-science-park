...
<body>
    <form class="box" method="post" action="<?php echo e(route('admin.login.submit')); ?>">
        <?php echo csrf_field(); ?>
        <img src="<?php echo e(asset('images/logo-science-park.png')); ?>" alt="Science Park">
        <h1>Адмін-панель</h1>
        <?php if($errors->any()): ?><div class="errors"><?php echo e($errors->first()); ?></div><?php endif; ?>
        <label>Email</label><input name="email" type="email" value="<?php echo e(old('email')); ?>" required autofocus>
...
<?php /**PATH C:\laragon\www\polissia-science-park\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>